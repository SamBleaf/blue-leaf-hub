...
export function buildMergeContext({ project = {}, job = {}, profile = {}, documentMeta = {} } = {}) {
  ...
  const ctx = {
    ...
    project_suburb: str(project.suburb || ""),
    project_state: str(project.state || "SA"),
    project_postcode: str(project.postcode || ""),
    ...
    project_description: str(project.description || job.description || ""),
