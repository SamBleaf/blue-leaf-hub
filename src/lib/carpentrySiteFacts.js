// carpentrySiteFacts.js — client mirror of server/lib/whs/carpentrySiteFacts.mjs (Questionnaire spec §2).
// Keep identical to the server so the builder's "Apply site facts" resolves the same controls the server
// would. scripts/tests/carpentry-sitefacts-parity.test.mjs asserts parity.
// ⚠ SAFETY-JUDGEMENT DATA — DRAFT until a competent WHS reviewer confirms each SF→control mapping.
