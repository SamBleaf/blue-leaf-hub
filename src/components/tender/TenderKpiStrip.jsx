...
import { fmtMoney } from "../../lib/tenderDashboard.js";
...
export default function TenderKpiStrip({ kpis }) {
  return (
    <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-6">
      ...
      <KpiCard label="Missing quotes" value={String(kpis.missing)} sub="across trades" tone={kpis.missing > 0 ? "warning" : "muted"} />
      ...
      <KpiCard label="Committed" value={fmtMoney(kpis.committed)} sub="awarded quotes, ex GST" tone={kpis.committed > 0 ? "primary" : "muted"} />
